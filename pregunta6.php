...
if (!isset($_SESSION["respuesta1"]) || $_SESSION["respuesta1"] != "nether" ||
    ...
    !isset($_SESSION["respuesta5"]) || $_SESSION["respuesta5"] != "si"
  ) {
  header("Location: pregunta5.php");
  exit();
}

if (isset($_SESSION["respuesta6"]) && $_SESSION["respuesta6"] == "3") {
...
<head>
  ...
  <style>
    body {
      ...
      margin-top: 220px;
      background-image: url("https://qph.cf2.quoracdn.net/main-qimg-33543713d280ebf0aaf030bed0818b23");
...
<form method="post" action="procesar.php">
  <p>Pregunta 6: ¿Cuantas cabezas de Esqueletos del Wither necesitas para invocar al Wither? </p>
  <input type="text" name="respuesta6">
