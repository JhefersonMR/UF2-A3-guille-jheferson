...
if (isset($_SESSION["respuesta3"]) && $_SESSION["respuesta3"] == "creeper") {
...
<head>
  ...
  <style>
    body {
      ...
      margin-top: 220px;
      background-image: url("https://media.tenor.com/8DoQFk9hEsUAAAAd/minecraft-sammear.gif");
...
<form method="post" action="procesar.php">
  <p>Pregunta 3: ¿Como se llama el Mob verde que explota?</p>
